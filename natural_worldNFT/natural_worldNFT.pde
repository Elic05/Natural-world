...
PImage [] bgImages = new PImage[19]; 
PImage [] seed = new PImage[19];
int index = 0;
int number = 0;
...
void setup() {
   ...
   bgImages[13] = loadImage("b14.png");
   bgImages[14] = loadImage("b15.png");
   bgImages[15] = loadImage("b16.png");
   bgImages[16] = loadImage("b17.png");
   bgImages[17] = loadImage("b18.png");
   bgImages[18] = loadImage("b19.png");
   ...
   seed[13] = loadImage("s2.png");
   seed[14] = loadImage("s3.png");
   seed[15] = loadImage("s4.png");
   seed[16] = loadImage("s5.png");
   seed[17] = loadImage("s1.png");
   seed[18] = loadImage("s7.png");
...
void draw() {
 ...
 void keyPressed(){
  if(key == 's'){
    println("Saving...");
    String s = "τὰ φυσικὰ" + "-" + nf(number,4) +".png";
    save(s);
    number++;
    println("Done saving.");
  }
